...
export type Event = Event_Balances | Event_CollatorSelection | Event_CumulusXcm | Event_Identity | Event_IdentityMigrator | Event_MessageQueue | Event_Multisig | Event_ParachainSystem | Event_PolkadotXcm | Event_Proxy | Event_Session | Event_System | Event_TransactionPayment | Event_Utility | Event_XcmpQueue
 ...
 * The `Event` enum of this pallet
 */
export type IdentityMigratorEvent = IdentityMigratorEvent_DepositUpdated | IdentityMigratorEvent_IdentityReaped
...
export const Event: sts.Type<Event> = sts.closedEnum(() => {
    return  {
        ...
        IdentityMigrator: IdentityMigratorEvent,
 ...
 * The `Event` enum of this pallet
 */
export const IdentityMigratorEvent: sts.Type<IdentityMigratorEvent> = sts.closedEnum(() => {
    return  {
        DepositUpdated: sts.enumStruct({
            who: AccountId32,
            identity: sts.bigint(),
            subs: sts.bigint(),
        }),
        IdentityReaped: sts.enumStruct({
            who: AccountId32,
        }),
    }
})
...
export type Type_369 = Type_369_Relay | Type_369_SiblingParachain

export interface Type_369_Relay {
    __kind: 'Relay'
}

export interface Type_369_SiblingParachain {
